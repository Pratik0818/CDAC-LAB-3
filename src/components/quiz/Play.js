  ...
  handleSubmitClick = (e) => {
    if(this.state.optionChoosen.toLowerCase().trim().length === 0){
      ...
      if ( this.state.optionChoosen.toLowerCase().trim() === this.state.answer.toLowerCase().trim()) 
      {
        ...
        if ( currentQuestion.noOfAttempts === this.state.noOfAttemptList[this.state.currentQuestionIndex] + 1 ) {
          this.setQuestionAttemptState();
          this.wrongAnswer();
        }
            ...
            <Fragment >
              ...
              <div className="questions ">
                ...
                {currentQuestion.questionType === "selectOptions" ? (
                  <Fragment>
                    <div  className= {currentQuestion.questionHasImg ? "main-quiz-component-img" : "main-quiz-component"}> {/* Main quiz container .... */}
                    <div className= {currentQuestion.questionHasImg ? "question-container-img" : "question-container"}>
                      <h5
                    ...
                    <div className= {currentQuestion.questionHasImg ? "main-option-container-img" : "main-option-container"}>
                    
                    {/*Display options of questions A and B... */}
                    <div className= {currentQuestion.questionHasImg ? "options-container-img" : "options-container"}>
                      <button
                        onClick={this.handleOptionClick}
                        disabled={questionTwiceWrongAttempt ? true : false}
                        className= {currentQuestion.questionHasImg ? "option-img" : "option"}
                        id="option-a"
                        style={{
